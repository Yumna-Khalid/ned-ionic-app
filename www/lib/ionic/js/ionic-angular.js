 ...
 * @usage
 * ```js
 * var NED_App = angular.module('reallyCoolApp', ['ionic']);
 *
 * NED_App.config(function($ionicConfigProvider) {
 ...
 * @usage
 * ```js
 * var app = angular.module('NED_App', ['ionic'])
 ...
 *
 * ```
 * angular.module('NED_App', ['ngRoute'])`
 * ```
 *
 * becomes
 *
 * ```
 * angular.module('NED_App', ['ngRoute', 'ngIOS9UIWebViewPatch'])
 * ```
 *
 *
 * More info:
